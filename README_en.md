...
const defaultOptions = {
  ...
  fromLang: 'zh-cn', // Source language, currently supported extraction languages: zh-cn(zh-tw), en, ja, ko, ru, use shouldExtract determine which languages to extract
