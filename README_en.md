...
extract-i18n-plugin is an all-in-one vite/rollup/webpack/babel/cli plugin that combines extract, compile, rewrite, and translate capabilities. It supports almost all currently known front-end frameworks. Such as React, Preact, Vue (including uni-app), Svelte5, Solid, Qwik, Lit, Angular, Ember and Marko. View [examples](https://github.com/semdy/extract-i18n-plugin/tree/main/examples) for more information. With this plugin, multilingual work becomes effortless and pain-free, providing a one-stop solution.
...
const defaultOptions = {
  ...
  destructuredHooks: true, // if true generate destructured hooks, e.g. const { t } = useTranslation() or generate const t = useTranslation()
  ...
  allowedExtensions: [".vue", ".nvue", ".uvue", ".svelte", ".tsx", ".ts", ".jsx", ".js", ".mjs", ".cjs", ".mts", ".cts", ".uts", ".marko", ".gjs",".gts",".hbs", ".html"], // Allowed file extensions for extraction
...
<a href="https://www.star-history.com/?repos=semdy%2Fextract-i18n-plugin&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=semdy/extract-i18n-plugin&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=semdy/extract-i18n-plugin&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=semdy/extract-i18n-plugin&type=date&legend=top-left" />
 </picture>
</a>
