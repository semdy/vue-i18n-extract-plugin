...
const defaultOptions = {
  ...
  pipeStyle: true, // 将Angular模板文本节点转换为pipe风格，如：<div>文本</div> -> <div>{{ 'id' | $t }}</div>，仅对Angular html模板有效
  ...
  allowedExtensions: [".vue", ".nvue", ".uvue", ".svelte", ".tsx", ".ts", ".jsx", ".js", ".uts", ".marko", ".html"], // 允许提取的文件扩展名
