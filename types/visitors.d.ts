...
export declare function createI18nVisitor(
  option: Partial<I18nOptions>,
  i18nMap?: I18nMap
): Record<string, (path: NodePath) => void>;

export declare function createI18nPlugin(
  option: Partial<I18nOptions>,
  i18nMap?: I18nMap
): () => { visitor: Record<string, (path: NodePath) => void> };

export declare function createI18nImportPlugin(
  option: Partial<I18nOptions>
): () => { visitor: Record<string, (path: NodePath) => void> };
