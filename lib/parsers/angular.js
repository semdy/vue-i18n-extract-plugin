...
function transformTemplate(code, options, ms, templateUrl, i18nMap) {
...
function processFile(code, options, templateUrl, i18nMap) {
  const ms = options.rewrite ? new MagicString(code) : null;
  const result = transformTemplate(code, options, ms, templateUrl, i18nMap);
