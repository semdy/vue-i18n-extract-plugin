...
import { generateId as _generateId } from "../utils.js";
    ...
    super({
      ...
      fetchMethod: async (
        ...
        try {
          ...
          console.warn("⚠️ 返回的文本内容：", content);
          console.warn("⚠️ 原文本内容：", JSON.stringify(sourceMap));
        }
