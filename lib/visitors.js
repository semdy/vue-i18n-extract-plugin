...
const { processAngularFile } = require("./parsers");
const { generateId, shouldExtract } = require("./core");
const { extractFunctionName, hasHtmlTag, EXCLUDED_CALL } = require("./utils");
