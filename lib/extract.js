...
function addI18nImportIfNeeded(ast, options, generateCode) {
  i18nImportAstTransform(
    ast,
    options.i18nPkgImportName,
    options.i18nPkgImportPath,
    options.useLocalImportName
  );
...
async function writeI18nMapToFile(i18nMap, options) {
...
async function handleFinalI18nMap(i18nMap, options) {
  await writeI18nMapToFile(i18nMap, options);
